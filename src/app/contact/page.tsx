        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <button
              ...
              className="w-full bg-amber-400 text-black font-medium py-3 px-6 rounded-lg hover:bg-amber-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
